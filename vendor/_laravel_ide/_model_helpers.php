...
namespace App\Models {
     ...
     * @property boolean $low_stock_notifications
     * @property boolean $request_notifications
     * @property array|null $cc_emails
     * @property string $admin_email
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings whereAdminEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings whereCcEmails($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings whereRequestNotifications($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings whereLowStockNotifications($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings whereLowStockThreshold($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<EmailSettings>|EmailSettings query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class EmailSettings extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property-read mixed $total_approved
     * @property-read mixed $status_badge
     * @property-read \App\Models\User $user
     * @property-read \App\Models\User $approvedBy
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\ItemRequestDetail> $details
     * @property-read int|null $details_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\ItemRequestLog> $logs
     * @property-read int|null $logs_count
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereRequestNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereNote($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereApprovedBy($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereApprovedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereAdminNote($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest query()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest pending() {@see App\Models\ItemRequest::scopePending()}
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequest>|ItemRequest byUser(mixed $userId) {@see App\Models\ItemRequest::scopeByUser()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ItemRequest extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\ItemRequestDetail
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $note
     * @property mixed $status
     * @property mixed $approved_quantity
     * @property mixed $requested_quantity
     * @property mixed $product_id
     * @property mixed $item_request_id
     * @property int $id
     * @property-read mixed $name
     * @property-read mixed $status_badge
     * @property-read mixed $is_partially_approved
     * @property-read mixed $is_fully_approved
     * @property-read \App\Models\ItemRequest $itemRequest
     * @property-read \App\Models\Product $product
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereItemRequestId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereProductId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereRequestedQuantity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereApprovedQuantity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereNote($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestDetail>|ItemRequestDetail query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ItemRequestDetail extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\ItemRequestLog
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $description
     ...
     * @property-read \App\Models\ItemRequest $itemRequest
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereItemRequestId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereAction($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereOldData($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereNewData($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemRequestLog>|ItemRequestLog query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ItemRequestLog extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property mixed $status
     * @property integer|null $max_stock_level
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereMaxStockLevel($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product byStatus(mixed $status) {@see App\Models\Product::scopeByStatus()}
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product byCategory(mixed $categoryId) {@see App\Models\Product::scopeByCategory()}
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product search(mixed $searchTerm) {@see App\Models\Product::scopeSearch()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @property string $id
     * @property-read mixed $last_activity_human
     * @property-read mixed $browser_info
     * @property-read mixed $os_info
     * @property-read \App\Models\User $user
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Session>|Session active() {@see App\Models\Session::scopeActive()}
     * @method static \Illuminate\Database\Eloquent\Builder<Session>|Session forUser(mixed $userId) {@see App\Models\Session::scopeForUser()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<StockMovement>|StockMovement whereMetadata($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User withRole(string $roleName) {@see App\Models\User::scopeWithRole()}
